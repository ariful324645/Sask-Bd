...
const VideoWork = () => {
  ...
  return (
    <section className="w-full bg-white py-8 md:">
        ...
        <div className="relative aspect-video w-full overflow-hidden rounded-[9px] bg-black">
          {!isPlaying ? (
            <>
              {/* Initial Image */}
              <img
                src="https://i.ibb.co.com/C5VNsPKp/4.jpg"
                alt={video.title}
            ...
            <iframe
              ...
              src={`https://www.youtube.com/embed/${video.videoId}?si=KHgPOfACDTc2YbsI&autoplay=1&rel=0`}
              title={video.title}
              frameBorder="0"
